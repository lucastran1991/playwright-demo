...
func Setup(authHandler *handler.AuthHandler, blueprintHandler *handler.BlueprintHandler, tracerHandler *handler.TracerHandler, capacityHandler *handler.CapacityHandler, jwtSecret, corsOrigin string) *gin.Engine {
	r := gin.Default()
